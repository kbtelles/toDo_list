...
export function item_component(numero_tareas){
    ...
    <div class="todo_item"> <!--Primer to do list-->
        <span class="icono" id="lll">☑️</span>  <!--Texto especial-->
            <p class="contenido_item" id="ola">
...
function tacharr(){
    document.querySelector(".contenido_item").classList.add("tachar");
    data_list.estado = false;
}
 document.querySelector(".todo_list").addEventListener("click", tacharr);
// VER EL ESTADO: console.log(data_list);
